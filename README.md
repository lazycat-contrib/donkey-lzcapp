...
Donkey 的 LazyCat LPK v2 打包仓库。应用使用已复制的 LazyCat Registry 镜像 `registry.lazycat.cloud/czyt/ca-x/donkey:ddbe5e3d8883fd08`，包名为 `community.lazycat.app.donkey`。容器以 root 用户运行，确保能够写入 LazyCat 持久目录。
